...
if __name__=='__main__':
    ...
    axes[0].hlines(y=acc_scores[4], xmin=0, xmax=n_comp_list[4], color ='k', linestyles='dashed')
    axes[0].vlines(x=n_comp_list[4], ymin=0, ymax=acc_scores[4], color ='k', linestyles='dashed')
    axes[0].hlines(y=acc_scores[18], xmin=0, xmax=n_comp_list[18], color ='k', linestyles='dashed')
    axes[0].vlines(x=n_comp_list[18], ymin=0, ymax=acc_scores[18], color ='k', linestyles='dashed')
