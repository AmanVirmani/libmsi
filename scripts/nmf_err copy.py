...
if __name__ == "__main__":
    ...
    cph_recon_err = np.hstack(
        [
            cph_recon_err,
            np.load("./npy_files/cph_recon_err_5_30_2.npy", allow_pickle=True),
        ]
    )
    ...
    naive_recon_err = np.hstack(
        [
            naive_recon_err,
            np.load("./npy_files/naive_recon_err_5_30_2.npy", allow_pickle=True),
        ]
    )
