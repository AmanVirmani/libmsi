...
class he_stains_kp:
    ...
    def he_stained_image_processing_pipeline(self, pipeline_parameters_dict=None, save_data=0, filename_prefixes='_pipeline_'):
        ...
        segmented_he_store_dict = self.segment_he_stained_images(segmentation_technique=all_pipeline_parameters_dict['segmentation_technique'], parameter_dict=all_pipeline_parameters_dict['segmentation_parameter_dict'], save_data=save_data, filename_prefix=filename_prefixes)
